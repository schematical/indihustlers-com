const Page = () => {
    return (
        <>
            ...
            before using [website URL] website (“website”, "service") operated by indihustlers.com
            ("us", 'we", "our").
            Conditions of use
            ...
            this Agreement, you are advised to stop using the website accordingly. indihustlers.com
            ...
            legally adhere to this Agreement. indihustlers.com assumes no responsibility for
            ...
            property of indihustlers.com, its affiliates, directors, officers, employees, agents,
            ...
            indihustlers.com’s intellectual property in any way, including electronic, digital, or new
            trademark registrations.
            You grant indihustlers.com a royalty-free and non-exclusive license to display, use,
            ...
            sort that might come between indihustlers.com and you, or its business partners and
            associates.
            Disputes
            ...
            Indemnification
            You agree to indemnify indihustlers.com and its affiliates and hold indihustlers.com
            ...
            indihustlers.com is not liable for any damages that may occur to you as a result of your
            misuse of our website.
            indihustlers.com reserves the right to edit, modify, and change this Agreement at any
            time. We shall let our users know of these changes through electronic mail. This
            Agreement is an understanding between indihustlers.com and the user, and this
